...
export default async (req: NextApiRequest, res: NextApiResponse) => {
  if (req.method === 'POST') {
    try {
      const response = await axios.post('https://interview-agent-demo.onrender.comnt-demo.onrender.comnt-demo.onrender.comnt-demo.onrender.comnt-demo.onrender.com/register', req.body);
